...
const products = [
  ...
  {
    id: 5,
    name: "Esmeril Angular Makita",
    category: "Herramientas",
    price: "$69.990",
    oldPrice: "$79.990",
    badge: "OFERTA",
    image:
      "https://images.unsplash.com/photo-1581147036324-c1c0d54d9d14?w=800",
  },
  {
    id: 6,
  ...
  return (
    <section className="featured-products">
      ...
      <div className="section-title">
        ...
        <p>
          Descubre algunos de nuestros productos más populares para tus proyectos.
        </p>
      </div>
